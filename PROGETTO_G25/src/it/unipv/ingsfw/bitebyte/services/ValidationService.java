...
public class ValidationService {
	...
	public static String controlloCampi(String cf, String nomeUtente, String email, String password,
			String confirmPassword, String nome, String cognome, LocalDate dataNascita, ClienteDAO clienteDAO) {
		if (cf.isEmpty() || nomeUtente.isEmpty() || email.isEmpty() || password.isEmpty() || confirmPassword.isEmpty()
				|| nome.isEmpty() || cognome.isEmpty() || dataNascita == null) {
