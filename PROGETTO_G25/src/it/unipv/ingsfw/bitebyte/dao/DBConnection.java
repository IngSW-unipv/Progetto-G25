...
public class DBConnection {
    ...
    /**
     * Percorso del file di configurazione che contiene le informazioni per la connessione al database.
     */
    private static final String CONFIG_FILE = "properties/dbconfig.properties";

    /**
     * Metodo per ottenere una connessione al database.
     * Carica le informazioni di configurazione dal file di proprietà e crea una connessione al database.
     *
     ...
     * Se la connessione è aperta, verrà chiusa.
     *
