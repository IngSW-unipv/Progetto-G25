...
/**
 * Classe astratta che rappresenta un utente del sistema BiteByte. L'utente può
 * essere di diversi tipi, come cliente o amministratore. Contiene le
 * informazioni personali di base, come il codice fiscale, il nome, il cognome,
 * l'email, la password e la data di nascita.
 * 
...
public abstract class Utente {
	...
	public Utente(String cf, String nome, String cognome, String password) {
		this.cf = cf;
		this.nome = nome;
		this.cognome = cognome;
		this.password = password;
